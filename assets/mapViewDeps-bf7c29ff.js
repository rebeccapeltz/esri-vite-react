import{g4 as Ie,lw as ae,eM as Ue,gN as $e,a6 as q,lx as ke,ly as Le,lz as Ne,iA as He,lA as qe,lB as Ge,eP as x,aE as Ve,aS as Pe,a0 as Ce,e$ as We,c2 as K,eO as Z,f5 as Y,kl as je,eU as oe,eV as Ke,eS as Ye,jL as Xe,jN as Qe,eX as le,hG as Je,k4 as Ze,lC as et,lD as tt,s as it,k6 as de,lE as rt,_ as ue,k7 as st,Y as nt,eJ as at,N as X,P as ot,aL as he,cQ as lt,lF as dt,aj as ce}from"./index-4f223f87.js";import{c as ut}from"./ExpandedCIM-b2f6ce2a.js";import{p as ht,s as ct}from"./imageUtils-aed01f25.js";import{t as _t,b as ft,o as _e,h as mt,i as pt}from"./Container-f6a10f50.js";import{i as gt}from"./BufferPool-8cb7fa3b.js";import{T as B,E as S,S as $}from"./color-19ec2e02.js";import{g as vt,a as L,h as G,w as A,d as bt,m as xt}from"./WGLContainer-a78f1963.js";import{L as E}from"./enums-fb086c25.js";import{e as wt,a as W,f as ee}from"./ProgramTemplate-01fb8414.js";import{n as U}from"./programUtils-9fcc7ed7.js";import{e as fe,r as yt,t as Tt,a as Ft,m as Bt,J as Et,n as Ot,b as Rt,c as Mt}from"./MagnifierPrograms-7e94905b.js";import{d as is,y as rs}from"./MagnifierPrograms-7e94905b.js";import{h as te,E as C,a as ie,i as Pt}from"./FramebufferObject-bebc1e31.js";import{R as v,E as H,F as re,O as j,I as Q,L as D,C as me,D as O,B as se,G as T,U as ne,P as Ct}from"./enums-bdecffa2.js";import{o as pe,N as St}from"./RenderingContext-1ffa3660.js";import{z as At,q as Dt,Q as zt,E as It,F as Ut,L as N,M as $t,_ as Se,R as ge}from"./definitions-bd9226bb.js";import{t as ve}from"./VertexElementDescriptor-2925c6af.js";import{e as R,T as k}from"./Texture-c521344f.js";import{r as ns}from"./GraphicsView2D-b1bf96b5.js";import{i as os}from"./GraphicContainer-5201c2da.js";import{t as be}from"./requestImageUtils-de6b6489.js";import"./BidiEngine-9a40f2f4.js";import"./visualVariablesUtils-b3ad2960.js";import"./OptimizedGeometry-d94e541f.js";import"./GeometryUtils-984e8446.js";import"./enums-f1a6a48a.js";import"./utils-dfd58d3b.js";import"./GeometryUtils-8cbe63b7.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-f4c8be77.js";import"./floatRGBA-bf0b0d3b.js";import"./AttributeStoreView-1f3ba8a0.js";import"./TiledDisplayObject-136f5b81.js";import"./util-b280f9b1.js";import"./StyleDefinition-29c49b98.js";import"./config-1337d16e.js";import"./earcut-08493f02.js";import"./featureConversionUtils-923ac988.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./NestedMap-1b5db22e.js";import"./rasterizingUtils-cc019866.js";import"./pbf-62b6db65.js";import"./imageutils-3aca76df.js";import"./Matcher-9eb3eb70.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-141bc973.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-024cefb3.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-82eed6cf.js";import"./TimeOnly-8a84a147.js";import"./OrderIndependentTransparency-6ae10952.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-0621f740.js";import"./projectionSupport-f3bc28ec.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-24cc5593.js";import"./FeatureContainer-440f59f5.js";import"./TileContainer-31f2e62c.js";import"./vec3f32-2da9db36.js";let kt=class{constructor(){this._resourceMap=new Map,this._inFlightResourceMap=new Map,this.geometryEngine=null,this.geometryEnginePromise=null}destroy(){this._inFlightResourceMap.clear(),this._resourceMap.clear()}getResource(e){return this._resourceMap.get(e)??null}async fetchResource(e,t){const i=this._resourceMap.get(e);if(i)return{width:i.width,height:i.height};let r=this._inFlightResourceMap.get(e);return r?r.then(n=>({width:n.width,height:n.height})):(r=ht(e,t),this._inFlightResourceMap.set(e,r),r.then(n=>(this._inFlightResourceMap.delete(e),this._resourceMap.set(e,n),{width:n.width,height:n.height}),()=>({width:0,height:0})))}deleteResource(e){this._inFlightResourceMap.delete(e),this._resourceMap.delete(e)}loadFont(e){return ut(e)}},Lt=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=Ue([$e(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),h=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return ke(f),Le(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[h,_]),f}};const Nt={background:{"background.frag":`#ifdef PATTERN
